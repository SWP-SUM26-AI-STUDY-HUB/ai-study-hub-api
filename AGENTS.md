...
| `config/CacheConfig.java` | `@EnableCaching` + `RedisCacheManager` (per-cache TTL, custom JSON serializer supporting Java 8 date/time like LocalDateTime). Cache-name constants: `trendingDocuments`, `publicTags`. |
