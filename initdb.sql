...
CREATE TABLE "tags" (
  ...
  "visibility" tag_visibility DEFAULT 'public',
  "created_by" uuid
);

CREATE UNIQUE INDEX "tags_public_label_idx" ON "tags" ("label") WHERE "visibility" = 'public';
CREATE UNIQUE INDEX "tags_private_user_label_idx" ON "tags" ("label", "created_by") WHERE "visibility" = 'private';
...
ALTER TABLE "tags" ADD FOREIGN KEY ("created_by") REFERENCES "users" ("id") ON DELETE SET NULL DEFERRABLE INITIALLY IMMEDIATE;
